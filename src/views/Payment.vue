  ...
  <div class="imp-container">
    ...
    >
      ...
      <a-form-item label="주문명">
        <a-input
          v-decorator="['name', { initialValue: '촉촉한 도넛' }]"
          size="large"
        />
      </a-form-item>
      ...
      <a-form-item label="이름">
        <a-input
          v-decorator="['buyerName', { initialValue: '전상현' }]"
          size="large"
        />
      </a-form-item>
      ...
      <a-form-item label="이메일">
        <a-input
          v-decorator="['buyerEmail', { initialValue: 'sjeon510@gmail.com' }]"
          size="large"
        />
      </a-form-item>
      <a-form-item label="주소">
        <a-input
          v-decorator="['buyerAddr', { initialValue: '서울시 금천구 남부순환로 썬오피스텔' }]"
          size="large"
        />
      </a-form-item>
